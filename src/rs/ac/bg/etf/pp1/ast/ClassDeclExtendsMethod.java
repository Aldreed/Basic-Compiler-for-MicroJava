...
public class ClassDeclExtendsMethod extends ClassDecl {
    ...
    public ClassDeclExtendsMethod (ClassName ClassName, ExtendsType ExtendsType, VarDeclList VarDeclList, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclExtendsMethod(\n");
