...
public class ClassDeclMethodConstr extends ClassDecl {
    ...
    public ClassDeclMethodConstr (ClassName ClassName, VarDeclList VarDeclList, ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclMethodConstr(\n");
